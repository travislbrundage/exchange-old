...
class Migration(migrations.Migration):
    dependencies = [
        ('account', '0005_auto_20180201_1836'),
    ]
        ...
        migrations.AlterField(
            ...
            field=account.fields.TimeZoneField(
                ...
                choices=[
                    ...
                    (b'US/Pacific', b'US/Pacific'), (b'US/Samoa', b'US/Samoa'),
                    (b'UTC', b'UTC'), (b'Universal', b'Universal'),
                    (b'W-SU', b'W-SU'), (b'WET', b'WET'), (b'Zulu', b'Zulu')
                ]),
        ),
    ]
